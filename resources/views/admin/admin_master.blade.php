...
<body>
        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="index.html" class="b-brand">
                    ...
                    <img src="{{asset('assets/images/logo-1.png')}}" alt="" class="logo logo-lg" />
                    <img src="{{asset('assets/images/logo-2.png')}}" alt="" class="logo logo-sm" />
                </a>
            </div>
            <div class="navbar-content">
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="reports-sales.html">Accounts Group</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="reports-leads.html">Accounts Sub Group</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="reports-project.html">Chart of Account</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="reports-timesheets.html">Subsidiary Ledger</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="reports-timesheets.html">Opening Balance</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="reports-timesheets.html">Receipt/Payment</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="reports-timesheets.html">Journal</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="reports-timesheets.html">Contra</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="reports-timesheets.html">Bank Reconciliation</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Operation</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="proposal.html">Member Application</a></li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Transaction</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{route('collection.history')}}">Collection History</a></li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Stystem</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Utility</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Agent Activity</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
    ...
    <main class="nxl-container">
        ...
        <footer class="footer">
            ...
            <p><span>By: <a target="_blank" href="https://google.com" target="_blank">theme_karnajit</a></span> • <span>Distributed by: <a target="_blank" href="https://google.com" target="_blank">Karnajit Namram</a></span></p>
